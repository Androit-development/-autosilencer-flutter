                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text('PRO',
                            style:
                                AppText.label(color: Colors.white, size: 10)),
                      ),
                    ],
                  ),
                ),
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(lang.t('Settings saved!',
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              Column(
                                  ...
                                  children: [
                                    Text('AutoSilencer',
                                        style: AppText.bodyBold(size: 18)),
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              ...
              style:
                  AppText.bodyBold(color: AppColors.onSurfaceVariant, size: 14),
            ),
          ),
          FilledButton(
